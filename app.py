...
MONGO_URI = os.getenv('MONGO_URI', 'mongodb+srv://engestonbrandonkiama_db_user:wYF2ngEfsfoXxDyY@cluster0.sxdpjue.mongodb.net/ecotrack?retryWrites=true&w=majority&ssl=true&ssl_cert_reqs=CERT_NONE&tlsAllowInvalidCertificates=true&tlsInsecure=true')
